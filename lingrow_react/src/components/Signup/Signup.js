...
export default function Form() {
    ...
    const translateMessage = useCallback((e) => {
        ...
        if (lang) {
            Translate(lang, "User Registration").then(response => setHeader(response));
            Translate(lang, "Email address*").then(response => setEmailMsg(response));
            Translate(lang, "Enter Email Address").then(response => setEnterEmailMsg(response));
            Translate(lang, "First name*").then(response => setFirstMsg(response));
            Translate(lang, "Enter First Name").then(response => setEnterFirstMsg(response));
            Translate(lang, "Middle name").then(response => setMiddleMsg(response));
            Translate(lang, "Enter Middle Name").then(response => setEnterMiddleMsg(response));
            Translate(lang, "Last name*").then(response => setLastMsg(response));
            Translate(lang, "Enter Last Name").then(response => setEnterLastMsg(response));
            Translate(lang, "User type*").then(response => setTypeMsg(response));
                Translate(lang, "Please select User Type").then(response => setEnterTypeMsg(response));
                Translate(lang, "Parent").then(response => setParentMsg(response));
                Translate(lang, "Teacher").then(response => setTeacherMsg(response));
                Translate(lang, "Researcher").then(response => setResearcherMsg(response));
                Translate(lang, "Admin").then(response => setAdminMsg(response));
            Translate(lang, "Please Select User Type").then(response => setEnterTypeMsg(response));
            Translate(lang, "Password*").then(response => setPasswordMsg(response));
            Translate(lang, "Enter Password").then(response => setEnterPasswordMsg(response));
            Translate(lang, "Confirm password*").then(response => setConfirmPasswordMsg(response));
            Translate(lang, "Enter password again").then(response => setEnterConfirmPasswordMsg(response));
            Translate(lang, "Child's Name(* if parent)").then(response => setChildMsg(response));
            Translate(lang, "Enter Child's Name").then(response => setEnterChildMsg(response));
            Translate(lang, "Error").then(response => setErrorMsg(response));
            Translate(lang, "Field with * is required").then(response => setRequiredMsg(response));
            Translate(lang, "Register").then(response => setRegisterBtn(response));
        }
    });
